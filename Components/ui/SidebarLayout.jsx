          ...
          >
            <Link href={item.path}>
              <Button
                ...
                className="flex items-center gap-1 px-2 w-full text-base font-normal text-gray-900 transition duration-75 normal-case bg-gray-50 shadow-none hover:font-semibold hover:shadow-none active:bg-blue-gray-50 focus:bg-blue-gray-50"
              >
                {item.icon}
                {item.label}
              </Button>
